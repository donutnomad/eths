...
var (
	...
	abiFlag = &cli.StringFlag{
		Name:  "abi",
		Usage: "Path to the Ethereum contract ABI json to bind, @artifact.json for artifact ABI and bytecode, - for STDIN",
	}
...
var app = NewApp("Ethereum ABI wrapper code generator")
